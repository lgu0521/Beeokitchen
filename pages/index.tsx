...
const Home: NextPage<Props> = ({ banners, miniBanners, popupBanners }) => {
  ...
  return (
    <>
      <Head>
        <title>헬키푸키</title>
        <meta name="description" content="건강을 키우는 다이어트푸드 키친, 헬키푸키(구)비오키친" />
        ...
        <meta property="og:description" content="아무리 바빠도, 나를 위한 건강하고 맛있는 한끼 건강한 식습관 헬키푸키" key="description" />
      </Head>
      <PageFullWidthLayout>
        <PCversion>
          <Carousel
