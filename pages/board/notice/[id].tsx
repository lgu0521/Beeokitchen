...
const NoticeDetailPage = ({ notice, PageTitle, noticeBeforeAfter }: Props) => {
  ...
  return (
    <div>
      <Head>
        <title>헬키푸키 브랜드 게시판 | 공지사항</title>
        <meta name="description" content="헬키푸키의 최신소식과 Q&A를 빠르게 확인하세요" />
        <link rel="canonical" href="https://www.xn--9w3b27lmmhzmc.kr/board" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="헬키푸키 브랜드 게시판 | 공지사항" />
        <meta property="og:site_name" content="헬키푸키 브랜드 게시판 | 공지사항" />
        ...
        <meta property="og:description" content="헬키푸키의 최신소식과 Q&A를 빠르게 확인하세요" key="description" />
      </Head>
