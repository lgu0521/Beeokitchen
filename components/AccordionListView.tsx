        ...
        <>
            <AccordionListBox>
                <Button onClick={() => setIsOpen(!isOpen)}>
                    ...
                    <Title3 style={{ fontWeight: 700 }}>{title}</Title3>
                    <DropIcon isOpen={isOpen} />
                </Button>
                <AccordionTextBox isOpen={isOpen}>
                    <Title2 style={{ color: "#15AA5A", marginRight: "15px", borderRadius: "50%", 
                            backgroundColor: "white", padding: "10px" }}>A</Title2>
                    <Title4><pre>{content}</pre></Title4>
                </AccordionTextBox>
            </AccordionListBox>
        </>
    );
