...
const ModifyAndDeleteMenuCatagory = ({ initialMenuCatagory }: Props) => {
  ...
  const onSubmit = async (data: MenuDTO) => {
    try {
      await fetch(
        process.env.NEXT_PUBLIC_API_URL + "/api/menu/modify/catagory",
        {
          method: "POST",
          body: JSON.stringify({
            ...data,
  ...
  const Delete = async () => {
    try {
      await fetch(
        process.env.NEXT_PUBLIC_API_URL + "/api/menu/delete/catagory",
        {
          method: "POST",
          body: JSON.stringify({
            id: initialMenuCatagory.id,
            title: initialMenuCatagory.title,
          }),
        }
      );
      ...
      <S.Form onSubmit={handleSubmit(onSubmit)}>
        <S.InputWrap>
          ...
          <S.Input
            ...
            defaultValue={initialMenuCatagory.title}
          />
        </S.InputWrap>
        <S.InputWrap>
          ...
          <S.Input
            ...
            defaultValue={initialMenuCatagory.content}
          />
        </S.InputWrap>
