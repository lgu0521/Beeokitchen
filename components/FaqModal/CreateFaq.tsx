        ...
        <>
           <S.Form onSubmit={handleSubmit(onSubmit)}>
                <S.InputWrap>
                    ...
                    <S.Input placeholder="FAQ 제목을 입력해주세요" {...register('title', { required: true, maxLength: 20 })} />
                </S.InputWrap>
                <S.InputWrap>
                    <S.Label>FAQ 내용</S.Label>
                    <S.Input placeholder="FAQ 내용 입력해주세요" {...register('content', { required: true, maxLength: 100 })} />
                </S.InputWrap>
